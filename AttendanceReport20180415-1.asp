...
%>   
      ...
      <%
           ...
           for inti=1 to intMonthLen
			  ...
			  if intm=6 AND ((inti>=15 AND inti <=21) and bitIsFistMember then
			     strColClassname = "colFistWeapons"
			  end if
			  if intm=6 AND ((inti>=22 AND inti <=28) and bitIsOnWeapons then
			     strColClassname = "colFistWeapons"
			  end if
...
strSQL = "SELECT dojoCd, IsActive, IsOnWeapons, IsFistmember, LName, FName, DOB, Division, AnchorDay, Phone FROM  dbo.dms_Student"
