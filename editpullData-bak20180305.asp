...
oRSr.ActiveConnection = oConn 
                   ...
                   Select Case strSortOrderCd
                          ...
                          Case 6
                             strSortOrder = "ORDER BY Division, LName, FName, MName, Division, AnchorDayOrder  "
                          Case 7
                             strSortOrder = "ORDER BY AnchorDayOrder,StatusID, LName, FName, MName, Division "
                          Case 8
...
End Select  
			   ...
			   strSQL = "Select TestingID, dms_TestPull.StudentID , dms_TestPull.DojoCd, LastTestingDate,  RankID, NextRankID, dms_TestPull.Division, dms_TestPull.Anchorday, AnchorDayOrder, StatusID, AddType, LName, FName, MName FROM dms_TestPull " 
 ...
 <h2>Sponsor: <%=strSponsoringSchoolname%></h2>		
			   ...
			   <table>
                  ...
                  <tr>
                     <td colspan="12"> <b>Test Date:</b>  <%=datTestingDate%>&nbsp;&nbsp; <b>Test Location:</b><%=strTestingLocationName%>&nbsp;&nbsp;<b> Testing ID:</b><%=intTestingID%>&nbsp;&nbsp;&nbsp;  <a href="Testing.asp"><span style="fontweight: bold;"><i class="far fa-certificate"></i>&nbsp;Return to Testing</span></a>
</td>
                  </tr>
			      <tr>
	     ...
	     <!--  <td class="dtabedit" align="center" ><a href="EditIndStudentMVA.asp?u=<%=intStudentID%>" onclick="window.open('EditIndStudentMVA.asp?u=<%=intStudentID%>', 'newwindow', 'width=1000,height=400,menubar=yes'); return false; "> <i class="fa fa-edit"></i></a></td> -->
                  ...
                  <td class="dtab"><a href="TransferToTS.asp?TID=<%=intTestingID%>&SID&<%=intStudentID%>">Xfer</a></td>
			 </tr> 
		</form>  
